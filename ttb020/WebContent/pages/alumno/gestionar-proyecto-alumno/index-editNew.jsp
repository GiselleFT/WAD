...
<body>
	...
	<s:set var="listGrupos" value="'4CM1'" />
	<div class="col-md-12">
		<h1 class="title">
			<s:property value="'Crear Proyecto'" />
		</h1>
	</div>

	<s:form id="frmRegistraProyect" method="post" theme="simple"
		action="%{#pageContext.request.contextPath}/alumno/gestionar-proyecto-alumno">
		<s:hidden name="idAlumno" value="%{idAlumno}" />
		<fieldset class="form form-horizontal form-medium">

			<!-- GRUPO -->
			<div class="form-group">
				<label class="col-xs-2 col-sm-4 col-md-4"> <s:text name="" />
				</label>
				<div class="col-xs-12 col-sm-8 col-md-4">
					<s:select id="slcTipo" name="model.idGrupo" list="listGrupo"
						listKey="id" listValue="nombre" headerKey="-1" headerValue="Grupo"
						cssClass="form-control" cssErrorClass="field-error" />
					<s:fielderror fieldName="model.idGrupo" cssClass="error"
						theme="bootstrap" />
				</div>
			</div>
			<!-- NOMBRE -->
			<div class="form-group outter-section">
				...
				<div class="col-xs-12 col-sm-8 col-md-4">
					<s:textfield cssClass="form-control" cssClassError="input-error"
						name="model.nombre" id="nGrupo" placeholder="Nombre del proyecto" />
