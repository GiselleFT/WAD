...
<jsp:text>
	...
	<script src="${pageContext.request.contextPath}/pages/diagrama/js/useCaseDiagram-edit.js" type="text/javascript"></script>
...
<body>
	...
	<div class="btn-group outter-section" role="group"
		...
		<s:else>
			...
			<button type="button" id="botonRel" class="hidden btn btn-secondary"
				style="background-color: black;">
				<label style="color: white;"><s:property
						value="'Asociación'" /></label>
			</button>
			<button type="button" id="botonExt" class="hidden btn btn-secondary"
				style="background-color: black;">
				<label style="color: white;"><s:property value="'Extensión'" /></label>
			</button>
			<button type="button" id="botonInc" class="hidden btn btn-secondary"
				style="background-color: black;">
				<label style="color: white;"><s:property value="'Inclusión'" /></label>
			</button>
	...
	<div class="row">
		<fieldset class="firstcolumn" style="background-color: #ffffff;">
			...
			<div id="inputActor" class="hidden">
		...
		<div class="thirdcolumn" id="comentarios">Columna de comentarios</div>
