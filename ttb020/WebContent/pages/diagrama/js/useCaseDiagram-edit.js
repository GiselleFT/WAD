...
window.onload = function(){
	...
	if (xmlData == null) {
		...
		usecaseDiagram.setXMLString(xmlData);
		usecaseDiagram.draw();
	}
  ...
  // Funcion primitiva para crear actor
     function crearActor(){
    	 function f(usecaseDiagram, a, b){
        	 ...
        	 if (nactor == "") {
               ...
               // consoleWrite( "<p align='left'>" + new
				// Date().toLocaleString() + " ==> <font
				// color='blue'>Info:</font> Actor <b>" + nactor + "</b> creado
				// correctamente.</p>");
        	 }
        	 cleanForm( 'nactor' );
        }
     ...
     /*
		 * Funcion para monitorear que por lo menos exista una relacion entre
		 * los elementos del diagrama var timerRel =
		 * setInterval(emptyRelationStack, 5000);
		 * 
		 * function emptyRelationStack(){ if((relationStack.length < 1) &&
		 * (useCaseStack.length > 0) && (actorStack.length > 0)) consoleWrite("<p align='left'>" +
		 * new Date().toLocaleString() + " ==> <font color='red'>Warn:</font>
		 * Debe de existir al menos una relacion entre los elementos existentes</p>"); }
		 */
     ...
     function crearSubSis(){
    	 function f(usecaseDiagram, a, b){
        	 ...
        	 if (nsubsis == "") {
            	...
            	// consoleWrite( "<p align='left'>" + new
				// Date().toLocaleString() + "==> <font
				// color='blue'>Info:</font> Subsistema <b>" + nsubsis + "</b>
				// creado correctamente.</p>" );
     ...
     function crearSis(){
    	 function f(usecaseDiagram, a, b){
        	 ...
        	 if (nsis == "") {
            	...
            	// consoleWrite( "<p align='left'>" + new
				// Date().toLocaleString() + "==> <font
				// color='blue'>Info:</font> Sistema <b>" + nsis + "</b> creado
				// correctamente.</p>" );
     ...
     function crearCu(){
    	 ...
    	 function f(usecaseDiagram, a, b){
        	 ...
        	 if (ncu == "") {
				...
				// + "==> <font color='blue'>Info:</font> Caso de uso <b>" + ncu
				// + "</b> creado correctamente.</p>" );
             }
     ...
     function crearRel(){
     	function f(usecaseDiagram, x1, y1, x2, y2){
     		...
     		if(((elemento1.getType() == "UMLActor") && (elemento2.getType() == "UMLUseCase")) || ((elemento1.getType() == "UMLUseCase") && (elemento2.getType() == "UMLActor"))){
         		...
         		// consoleWrite( "<p align='left'>" + new
				// Date().toLocaleString() + "==> <font
				// color='blue'>Info:</font> Asociacion <b>" +
				// elemento1.getName() + "-" + elemento2.getName() + "</b>
    	 ...
    	 function f(usecaseDiagram, x1, y1, x2, y2){
    		var elemento1 = usecaseDiagram.getElementByPoint(x1,y1);
      		...
      		if((elemento1.getType() == "UMLUseCase") && (elemento2.getType() == "UMLUseCase")){
	      		...
	      		relationStack.push( x1.toString() + y1.toString() + x2.toString() + y2.toString());
	      	// consoleWrite( "<p align='left'>" + new Date().toLocaleString() +
			// "==> <font color='blue'>Info:</font> Extension <b>" +
			// elemento1.getName() + "-" + elemento2.getName() + "</b> creada
			// correctamente</p>" );
    		...
    		var elemento1 = usecaseDiagram.getElementByPoint(x1,y1);
      		...
      		if((elemento1.getType() == "UMLActor") && (elemento2.getType() == "UMLActor")){
	      		...
	      		if( y2>y1 ){
	      			// consoleWrite("<p align='left'>" + new
					// Date().toLocaleString() + " ==> <font
					// color='green'>Tip:</font> &#191El actor <b>" +
					// elemento1.getName() + " </b>hereda del actor <b>" +
					// elemento2.getName() + "</b>? <a onclick='cambiaPos()'>Si
					// es asi, "
	      			// + "se recomienda colocar <b>" + elemento1.getName() +
					// "</b> debajo del actor que se hereda (<b>" +
					// elemento2.getName() + "</b>) </a></p>");
	      		...
	      		if( y2>y1 ){
	      			...
	      			consoleWrite("<p align='left'>" + new Date().toLocaleString() + " ==> <font color='green'>Tip:</font> O quiza &#191<b>" + elemento2.getName() + " </b>es como <b>" + elemento1.getName() + "</b>? Se recomienda invertir los caso de uso y colocar la direccion " +
	    	      			"de la herencia del caso de uso <b>" + elemento2.getName() + "</b> hacia el caso de uso <b>" + elemento1.getName() + "</b></p>");
	      		}
      		}else{
